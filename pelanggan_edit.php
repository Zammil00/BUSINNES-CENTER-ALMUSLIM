...
<form id="form1" name="form1" method="post" action="index.php?file=proses_pelanggan_edit">
  <table width="100%" align="center">
    ...
    <tr valign="baseline">
      ...
      <td align="left" valign="middle"><input type="password" name="password" value="<?=$plg['password'];?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
